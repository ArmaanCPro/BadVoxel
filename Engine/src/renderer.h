...
public:
    ...
    virtual void load_vertices(const float* verts, size_t size);
    ...
    virtual void draw_vertices(const Camera& camera, float screenWidth, float screenHeight, bool wireframe = false);
